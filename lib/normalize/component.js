...
Component.prototype.end = function* () {
  ...
  yield* commonjs(this.path + 'index.js', this.dependencies.dependencies)
...
Component.prototype.getCSSDependencies = function* () {
  var deps = yield this.dependencies.repositories.component
  .map(function* resolveCSS(repo) {
...
Component.prototype.rewriteJS = function* () {
  ...
  if (main !== 'index.js') {
    ...
    if (!/\.js$/.test(main))
      return this.log('error', 'non-js file main, aborting normalization')
    if (~scripts.indexOf('index.js'))
      return this.log('error', 'index.js not main, aborting normalization')
