...
describe('Walker', function () {
  describe('component-test/index', function () {
    ...
    it('should have rewritten the JS dependencies', co(function* () {
      ...
      index.remoteURI.should.equal('https://github.component.io/component-test/index/0.0.0/index.js');

      var file = index.file;
      file.string.should.not.include('module stuff from "./stuff.js";');
      file.string.should.include('module stuff from "https://github.component.io/component-test/index/0.0.0/stuff.js";')
    ...
    it('should have rewritten the CSS dependencies', function () {
      ...
      index.remoteURI.should.equal('https://github.component.io/component-test/index/0.0.0/index.css');

      var file = index.file;
      file.string.should.not.include('@import "./something.css";');
      file.string.should.include('@import "https://github.component.io/component-test/index/0.0.0/something.css";')
